...
### What load or daily active users is the mobile app expected to handle at launch?

_Why this matters: it decides whether we provision distributed infrastructure now or keep a lightweight serverless architecture._
