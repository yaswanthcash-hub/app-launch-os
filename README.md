...
App Launch OS provides a structured command protocol that AI coding assistants (Google Antigravity, Claude Code, Cursor, Windsurf) execute using workspace tools:
