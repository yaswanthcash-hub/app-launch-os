...
Some topics may require more skills than knowledge. Learning more about theoretical physics might be more knowledge-based. For mobile app engineering or design, more skills-based.
...
- Design tokens, concentricity math, and styling rules
